...
function FloatingTextFormat({
  ...
  const $updateTextFormatFloatingToolbar = useCallback(() => {
    ...
    if (
      ...
      const popupRect = popupCharStylesEditorElem.getBoundingClientRect()
      let top = rangeRect.top - popupRect.height - 10
      let left = rangeRect.left + rangeRect.width / 2 - popupRect.width / 2
      ...
      popupCharStylesEditorElem.style.position = "fixed"
      popupCharStylesEditorElem.style.top = `${top}px`
      popupCharStylesEditorElem.style.left = `${left}px`
      popupCharStylesEditorElem.style.transform = "translate(0, 0)"
      popupCharStylesEditorElem.style.pointerEvents = "auto"
    } else {
      popupCharStylesEditorElem.style.opacity = "0"
      popupCharStylesEditorElem.style.transform = "translate(-10000px, -10000px)"
    }
  ...
  return (
    <div
      ...
      className="bg-background fixed z-[10000] flex gap-1 rounded-md border p-1 opacity-0 shadow-md transition-opacity duration-300 will-change-transform"
    >
      {editor.isEditable() && (
        <>
          <ToggleGroup
